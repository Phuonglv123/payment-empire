...
const mockCampaign: Campaign = {
  ...
  product: 'Gói đăng ký 1 năm',
  imageUrl: '/next.svg', // Using local image for demo
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6">
          ...
          <CampaignInfo campaign={mockCampaign} />
          ...
          {!showQRCode ? (
            <form onSubmit={handleSubmitPayment} className="space-y-6">
              ...
              {/* Payment Method */}
              <PaymentMethod bankCode={mockCampaign.bankCode} />
            ...
            <QRCodeDisplay
              qrCodeUrl="/next.svg"
              amount={mockCampaign.finalPrice}

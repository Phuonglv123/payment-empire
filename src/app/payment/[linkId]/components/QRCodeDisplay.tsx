  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
      ...
      <div className="flex justify-center mb-6">
        <div className="relative w-64 h-64 border-4 border-[#F5A623] rounded-xl overflow-hidden shadow-lg">
          <Image
            src={qrCodeUrl}
            alt="QR Code"
            fill
      ...
      {/* Instructions */}
      <div className="bg-gradient-to-r from-[#FFF8E8] to-[#FFE8B8] border border-[#F5A623] rounded-lg p-4 mb-4">
